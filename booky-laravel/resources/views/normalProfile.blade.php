        ...
        <div class="librosInfo row">
          <div class="librosAPrestar col-12 row w-100 mx-auto">
            ...
            @forelse ($userBooks as $userBook)
              ...
              <img class="card-img-top mx-auto mt-1" src="/storage/{{$userBook->image}}" alt="Imagen del libro">
              <div class="card-body">
                <h5 class="card-title">{{$userBook->title->name}}</h5>
                <a href="/bookPost/{{$userBook->id}}" class="btn btn-success">Ver detalle</a>
              </div>
            </div>
                {{-- <div class="book-image col-md-6 col-lg-3">
                  <a href="/bookPost/{{$userBook->id}}">
                   <img class="rounded mx-auto d-block" src="/storage/{{$userBook->image}}" alt="">
                  </a>
                </div> --}}
            @empty
