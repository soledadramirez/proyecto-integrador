<?php
require_once "funciones-recuperado.php"; //session_start() está en funciones.php no hay que ponerlo otra vez;
$errores = [];
...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="css/registracion3.css">
            ...
            <article class="datos">
              ...
              <div class="pass">
                ...
                <div class="repeatPass">
                  <label for="repeatPass"><i class="fas fa-lock"></i></label>
                <?php if (isset($errores["repeatPass"])): ?>
                  <input id="pass" type="password" name="pass" value="" placeholder= "repetir contraseña">
                  <p class = "errores"> <?= $errores["repeatPass"] ?> </p>
                <?php else: ?>
                  <input id="repeatPass" type="password" name="repeatPass" value="" placeholder= "repetir contraseña">
                <?php endif; ?>
              </div>
